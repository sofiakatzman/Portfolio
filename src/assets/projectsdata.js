const PROJECTSDATA = [
  {
    name: "Milestones",
    summary:
      "A social platform dedicated to illustrating user's life accomplishments via milestones aimed at displaying a user's 'full life' in an effort to understand their journey and development better. ",
    stack:
      "React front-end, Python backend with Flask API. Websocket.io integration for instant user updates. Bcrypt for user authentication and authorization. UseContext global state handling.",
    ...
    caseStudy: {
      problem:
        "People often struggle with sharing their life accomplishments in a consolidated way.",
      solution:
  ...
  },
  {
    name: "RecycleQuest",
    summary:
      "A gamified social platform aimed at increasing recycling knowledge and awareness, as well as creating a competitive and engaging environment to promote contributions. ",
    stack:
      "React front-end, Ruby on Rails backend, deployed Postgres database and API. UseContext global state handling.",
    ...
    caseStudy: {
      problem:
        "Lack of recycling knowledge and engagement among users leads to low recycling rates.",
      solution:
  ...
  },
  {
    name: "BunnyWalks",
    summary:
      "A full-stack application designed to keep a record of bunnies enoucountered on walks, the paths taken, and identities of bunnies seen.",
    stack: "React front-end, Python backend with Flask API.",
    ...
    livedemo: false,
    image:
      "https://img.freepik.com/premium-vector/easter-bunny-continuous-one-line-drawing-minimalist-hand-drawn-illustration-isolated-element-vector_593228-160.jpg",
    details: {
      description:
        "BunnyWalks is a full-stack application designed to record walks, paths, and bunny encounters. The project features a React front-end and a Python backend with a Flask API. It offers both mobile and web versions for user convenience.",
      keyFeatures: [
    ...
    caseStudy: {
      problem:
        "My neighbors often wanted to keep track of their walks and encounters with bunnies within our community, but lack a centralized platform for recording and viewing this information.",
      solution:
        "BunnyWalks provides a full-stack application that allows users to log their walks, paths, and bunny encounters, providing a convenient way to organize and review their experiences.",
      media: [
  ...
  },
  {
    name: "EventManager",
    summary:
      "A Command Line Interface Application designed to streamline the process of hiring and booking event staff.",
    stack:
      "Python backend with SQLAlchemy database. No GUI; entirely designed using text and special characters. ",
    ...
    livedemo: false,
    image:
      "https://media.istockphoto.com/id/1197573398/vector/continuous-one-line-drawing-clock-icon-with-doodle-handdrawn-style-on-white-background.jpg?s=612x612&w=0&k=20&c=9AqkHQ2FILkhU-M7mn3K-zDUX7-WX6NO93FoDSuThCc=",
    details: {
      description:
        "EventManager is a Command Line Interface (CLI) application designed to streamline the process of hiring and booking event staff. The project is built with a Python backend and utilizes the SQLAlchemy database library for efficient data management. It provides a text-based design for interacting with the application.",
      keyFeatures: [
    ...
    caseStudy: {
      problem:
        "Event organizers often face challenges in efficiently booking and tracking event staff, leading to potential inefficiencies and miscommunications.",
      solution:
